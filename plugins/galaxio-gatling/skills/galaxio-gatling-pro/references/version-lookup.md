...
- The number goes into the build file for your language and build tool — the build reference dispatch sent you to names it, and says where a version catalog keeps it instead.
